...
#define MAX_WINDOW_TITLE_LENGTH 2024
...
public:
	...
	void UpdateWindowTitle(LPCTSTR title) { 
		UTL_strncpy(m_windowTitle,  UTL_Null(title), MAX_WINDOW_TITLE_LENGTH - 1); 
		_data.pszAddInfo = m_windowTitle;
		updateDockingDlg();
	};

	TCHAR				m_windowTitle[MAX_WINDOW_TITLE_LENGTH];
